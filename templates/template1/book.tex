...
\newcommand{\geopoint}[4]{#4
  \footnote{
    \href{https://www.google.com/maps?q=#1,#2}
    {#4: \ifthenelse{\equal{#3}{}}{}{высота~\numprint{#3}~м, }координаты~\nprounddigits{6}\numprint{#1}, \numprint{#2}}
  }
}

\newcommand{\routeKey}[1]{\textbf{#1}}

\newmdenv[topline=false,bottomline=false,rightline=false,linewidth=2pt]{routeSectionEnv}
